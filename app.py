...
# Entradas da fatura
st.markdown("### ✍️ Informe os dados principais da fatura:")
...
if fatura and geracoes and len(geracoes) == 2 and data_inicio and data_fim:
    ...
    st.info("📌 Envie a fatura, exatamente **2 arquivos de geração**, e preencha os campos obrigatórios para análise.")
